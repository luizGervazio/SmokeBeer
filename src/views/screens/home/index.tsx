    ...
    <SafeAreaView style={styles.container}>
     ...
     <Portal>
      <Dialog visible={dialogVisible} onDismiss={() => setDialogVisible(false)}>
        <Dialog.Title>Produto adicionado</Dialog.Title>
        <Dialog.Content>
          <Paragraph>{dialogMessage}</Paragraph>
        </Dialog.Content>
        <Dialog.Actions>
          <Button onPress={() => setDialogVisible(false)}>Continuar Comprando</Button>
          <Button onPress={() => {
            setDialogVisible(false);
            navigation.navigate('Carinho'); // Nome da tela do carrinho
          }}>
            Ver Carrinho
          </Button>
        </Dialog.Actions>
